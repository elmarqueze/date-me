...
const Home = () => {
  ...
  <>
        ...
        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
          ...
          <div>
            <div className="lg:w-[570px]">
              ...
              <p className='text__para'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Mollitia nesciunt amet quis libero temporibus praesentium commodi reprehenderit labore nam eius.</p>
    ...
    <section>
      <div className="container">
      <div className="xl:w-[470px] mx-auto">
          <h2 className="heading text-center">Our patients say</h2>
          <p className='text__para text-center'>
            World-class care for everyone. Our health System offers unmatched, expert health care.
          </p>
        </div>
